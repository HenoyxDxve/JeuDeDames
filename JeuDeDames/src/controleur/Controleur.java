...
public class Controleur extends Application {
	...
	/**
	 * 
	 * @param blancs      liste des pieces blancs avec leur position finale
	 * @param noirs       liste des pieces noirs avec leur position finale
	 * @param piece       la piece avec sa position initiale
	 * @param deplacement liste des cases qui par lesquelles passe la piece 'piece'
	 * 
	 */
	...
	/**
	 * 
	 * @param piece       : la piece a deplacer etant a sa position d'origine
	 * @param deplacement : les cases constituant le trajet
	 * @return
	 */
